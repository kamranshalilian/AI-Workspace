...
**Status:** Phase 3 implemented: `init`, `status`, `validate`, `doctor`, `agent create|add|remove|list|status`, `export`.
...
Source commands, import/export-sync, and workspace `--all` are **not** available yet.
